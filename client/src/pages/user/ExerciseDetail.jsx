    ...
    <div className="h-screen w-screen flex flex-col bg-blue-50">
      ...
      <div className="flex flex-grow justify-center p-8 relative">
        <div className="bg-white bg-opacity-75 p-8 rounded-lg shadow-lg w-3/5 mr-8">
          <h2 className="text-xl font-semibold text-gray-800 mt-10 mb-20">Văn bản 1: Trái Đất - cái nôi của sự sống</h2>
        ...
        <div className="w-80 h-60 mt-20 ml-10 flex flex-col items-center justify-center bg-red-100 rounded-lg shadow-lg p-4">
