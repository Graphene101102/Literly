...
const DocumentVietnameseKnowledgeManagement = () => {
  return (
        ...
        <div className="relative flex-grow p-8">
          ...
          <div className="relative z-10 bg-red-50 bg-opacity-75 p-8 mt-10 w-full h-4/5 rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <button className="bg-red-100 text-red-800 font-bold py-12 px-6 rounded-lg shadow-md text-center text-xl border-2 border-red-500">
...
export default DocumentVietnameseKnowledgeManagement;
