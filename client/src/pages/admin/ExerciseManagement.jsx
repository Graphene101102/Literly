          ...
          <div className="relative z-10 bg-red-50 bg-opacity-75 p-8 mt-10 w-full h-4/5 rounded-lg shadow-lg">
            ...
            <div className="space-y-4">
              {exercises.map((exercise, index) => (
                <div key={exercise.id} className="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm">
                  <span className="text-xl font-medium text-gray-800">{`${index + 1}. ${exercise.title} ${exercise.author ? `(${exercise.author})` : ''}`}</span>
